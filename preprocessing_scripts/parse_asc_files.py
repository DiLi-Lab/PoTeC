...
#files = [f for f in os.listdir('../data') if re.match(r'.*.asc', f)]
# 32.asc und 62.asc sind kaputt
# TODO loeschen
#files = ['63.asc', '64.asc', '65.asc', '66.asc', '67.asc', '68.asc', '69.asc', '7.asc', '70.asc', '71.asc', '72.asc', '73.asc', '74.asc', '75.asc', '76.asc', '77.asc', '78.asc', '79.asc', '8.asc', '80.asc', '81.asc', '82.asc', '83.asc', '84.asc', '85.asc', '87.asc', '9.asc', '90.asc', '91.asc', '92.asc', '93.asc', '94.asc', '95.asc', '96.asc', '97.asc', '98.asc', '99.asc']

files = ['62.asc']
#files = ['32.asc']
#files = ['31.asc', '32.asc', '34.asc', '35.asc', '36.asc', '37.asc', '38.asc', '39.asc', '4.asc', '40.asc', '41.asc', '5.asc', '6.asc', '60.asc', '61.asc', '62.asc', '63.asc', '64.asc', '65.asc', '66.asc', '67.asc', '68.asc', '69.asc', '7.asc', '70.asc', '71.asc', '72.asc', '73.asc', '74.asc', '75.asc', '76.asc', '77.asc', '78.asc', '79.asc', '8.asc', '80.asc', '81.asc', '82.asc', '83.asc', '84.asc', '85.asc', '87.asc', '9.asc', '90.asc', '91.asc', '92.asc', '93.asc', '94.asc', '95.asc', '96.asc', '97.asc', '98.asc', '99.asc']
...
practice_on = re.compile('.*SYNCTIME_sentence_Practice') # if practice trial (fix for files where practice was recorded)
practice_off = re.compile('.*TRIALID 1') # in files with practice data, TRIALID 1 marks end of practice (but not in other files!
...
for file in files:
    with open(os.path.join('../data', file), 'r') as f:
        ...
        for line in f.readlines():
            ...
            elif not select and not practice: # look for trial and text id only outside of eye mov samples and outside practice
                # get trial id
            ...
            if trial and text:
                try:  # in sessions with practice, all trial DVs (including trial and item) were send 12 times rather than once; in these cases, temp does not exist after the first encounter; therefore skip all except for the first occurrence
                     os.rename('temp', id+'_'+text+'_trial'+trial+'.csv')
                     trial = None
                     text = None

                except FileNotFoundError: # temp has not been created
                    trial = None # here, trial, text must have been set before the next eye mov section was parsed (in files with practice trial recodrding, variables are written multiple times to data)
                    text = None
    print(file)
